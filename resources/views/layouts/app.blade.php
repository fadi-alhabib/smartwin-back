		...
		<div class="dlabnav">
			<div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
					<li class="dropdown header-profile">
						<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
							<div class="header-info ms-3">
								<span class="font-w600 ">مرحبا, <b> {{ auth()->user()->first_name }} </b></span>
								<small class="text-end font-w400"> {{ auth()->user()->username }} </small>
							</div>
					...
					<li><a href="{{ route('privilege') }}" class="ai-icon" aria-expanded="false">
