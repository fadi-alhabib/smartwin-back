            ...
            <div class="row">
                ...
                @foreach ($ads as $ad)
                    <div class="col-xl-6">
                        <div class="card">
                            @if ($ad->is_img)
                                <img class="card-img-top img-fluid" src="{{ $ad->path }}" alt="Card image cap">
                            @else
                                <video controls>
                                    <source src="{{ $ad->path }}">
                                    <p>
                            ...
                            <div class="card-body">
                                ...
                                <!-- ///////////////////////// -->
                                <form action="{{ route('advertisementStatus') }}" method="POST"
                                    id="advertisementStatus_{{ $ad->id }}">
                                    @csrf
                                    ...
                                    @if ($ad->is_active)
                                        ...
                                        <input type="submit" class="badge badge-success" style="display:block"
                                            value="active">

                                </form>
                            @else
                                <form action="{{ route('advertisementStatus') }}" method="POST"
                                    id="advertisementStatus{{ $ad->id }}">
                ...
                <div class="d-flex">
                    ...
                    <a href="{{ route('advertisement.edit', $ad->id) }}" class="btn btn-primary shadow btn-xs sharp "><i
