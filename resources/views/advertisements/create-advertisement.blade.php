            ...
            <div class="card-body">
                ...
                <form action="{{ route('advertisement.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" id="title" class="form-control input-default" value="{{ old('title') }}" placeholder="" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="from_date" id="from_date" class="form-control input-default " placeholder="" required>
                    </div>

                    <div class="mb-3">
                        <label for="to_date" class="from-label">انتهاء بـ</label>
                        <input type="date" name="to_date" id="to_date" class="form-control input-default " placeholder="" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="radio" name="home_ad" id="home_ad" class="form-check-input" value="1" checked><br>
                        ...
                        <input type="radio" name="home_ad" id="not_home_ad" class="form-check-input" value="0" placeholder="">
                    </div>
