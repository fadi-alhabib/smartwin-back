            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.update', $admin[0]->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="first_name" id="first_name" type="text" class="form-control input-default " placeholder="" value="{{ $admin[0]->first_name }}" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input name="last_name" id="last_name" type="text" class="form-control input-default " placeholder="" value="{{ $admin[0]->last_name }}" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input name="username" id="username" type="text" class="form-control input-default " placeholder="" value="{{ $admin[0]->username }}" readonly>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input name="phone" id="phone" type="text" class="form-control input-default " placeholder="" value="{{ $admin[0]->phone }}" required>
                    </div>
